...
5. Right-click `INSTALL-WINDOWS-SERVER.cmd` and click **Run as administrator**.

6. Wait for the installer to finish.

7. Open the browser on the PC and go to:
...
10. Open **Settings > Server Setup** and set **Public Base URL** if users will connect from other PCs.
...
- Browser opens `http://localhost:3001/setup`
