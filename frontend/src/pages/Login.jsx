  ...
  return (
    <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        <div className="mb-4 rounded-xl border border-info/40 bg-info/10 px-4 py-3 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-info">Live Build Marker</p>
          <p className="mt-1 text-sm text-slate-200">PROXY-TOGGLE-V4</p>
        </div>
